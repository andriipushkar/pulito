...
test.describe('Cart Flow', () => {
  test('should add item from catalog and update cart count', async ({ page }) => {
    ...
    const addButton = page
      .locator(
        'button:has-text("кошик"), button:has-text("Додати"), button:has-text("Купити"), [data-testid="add-to-cart"]',
      )
      .first();
    ...
    const cartBadge = page
      .locator(
        '[data-testid="cart-count"], [class*="cart"] [class*="badge"], [class*="cart"] span, a[href="/cart"] span',
      )
      .first();
  ...
  test('should change quantity in cart', async ({ page }) => {
    ...
    const increaseButton = page
      .locator('button:has-text("+"), [data-testid="increase-qty"]')
      .first();
  ...
  test('should remove item from cart', async ({ page }) => {
    ...
    const removeButton = page
      .locator(
        'button:has-text("Видалити"), button:has-text("видалити"), [data-testid="remove-item"], button[aria-label*="видалити"], button[aria-label*="Видалити"]',
      )
      .first();
