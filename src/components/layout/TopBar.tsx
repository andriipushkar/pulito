      ...
      <Container className="hidden items-center justify-between py-1.5 sm:flex">
        <div className="flex items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-1 font-medium text-[var(--color-text)] transition-colors hover:text-[var(--color-primary)]"
          >
            <Phone size={13} />
          ...
          <Link
            href="/contacts"
            className="hidden items-center gap-1 transition-colors hover:text-[var(--color-primary)] md:inline-flex"
          >
          ...
          <Link
            href="/faq"
            className="hidden items-center gap-1 transition-colors hover:text-[var(--color-primary)] lg:inline-flex"
          >
            <HelpCircle size={13} />
            Питання
          </Link>
