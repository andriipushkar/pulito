...
const mockData = {
  totalCustomers: 100,
  segments: [
    { segment: 'champions', label: 'Champions', count: 20, avgRecency: 5, avgFrequency: 10, avgMonetary: 5000, color: '#22c55e' },
    { segment: 'loyal', label: 'Loyal', count: 30, avgRecency: 15, avgFrequency: 5, avgMonetary: 2000, color: '#3b82f6' },
    { segment: 'at_risk', label: 'At Risk', count: 10, avgRecency: 60, avgFrequency: 2, avgMonetary: 500, color: '#dc2626' },
  ],
};
