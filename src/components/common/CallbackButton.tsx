  ...
  return (
    <>
      <button
        ...
        className={
          triggerClassName ||
          'fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-primary)] text-white shadow-lg transition-transform hover:scale-110'
        }
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                  ...
                  <select
                    ...
                    aria-label="Зручний час дзвінка"
                    className={inputClass}
                  >
