...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Зареєструйтесь на сайті та подайте заявку на гуртовий статус у кабінеті клієнта. Менеджер розгляне заявку протягом 1-2 робочих днів.',
  },
  {
...
export default function ChatWidget({ triggerClassName, iconSize }: ChatWidgetProps) {
  ...
  const telegramBotUrl = process.env.NEXT_PUBLIC_TELEGRAM_BOT_URL || 'https://t.me/PulitoTradeBot';
          ...
          <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between bg-[var(--color-primary)] px-4 py-3 text-white">
                <div>
                  <h3 className="text-sm font-bold">Pulito Trade</h3>
