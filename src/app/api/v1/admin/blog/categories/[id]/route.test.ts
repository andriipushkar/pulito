...
describe('PATCH /api/v1/admin/blog/categories/[id]', () => {
  ...
  it('updates category on success', async () => {
    (updateBlogCategorySchema.safeParse as any).mockReturnValue({ success: true, data: { name: 'Updated' } });
  ...
  it('returns 500 on error', async () => {
    (updateBlogCategorySchema.safeParse as any).mockReturnValue({ success: true, data: { name: 'X' } });
