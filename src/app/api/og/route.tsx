...
export async function GET(request: NextRequest) {
  ...
  const title = searchParams.get('title') || 'Pulito Trade';
  ...
  return new ImageResponse(
    ...
    >
      {/* Product image — Satori (vercel/og) renders via <img>, next/image is not supported in edge ImageResponse */}
      {image && (
        <div
          style={{
            width: '400px',
      ...
      >
        ...
        {price && (
          <div
            style={{ display: 'flex', alignItems: 'baseline', gap: '16px', marginBottom: '20px' }}
          >
            <div
              style={{
                fontSize: '52px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: 'auto' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#2563eb' }}>Pulito Trade</div>
