...
describe('sitemap-products chunk route', () => {
  ...
  it('returns 404 for empty chunk', async () => {
    ...
    const response = await GET(new Request('http://localhost:3000/sitemap-products/999'), {
  ...
  it('returns 404 for invalid chunk', async () => {
    const response = await GET(new Request('http://localhost:3000/sitemap-products/abc'), {
  ...
  it('returns 404 for negative chunk', async () => {
    const response = await GET(new Request('http://localhost:3000/sitemap-products/-1'), {
