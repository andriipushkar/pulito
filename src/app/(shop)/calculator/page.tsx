...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Калькулятор витрат на побутову хімію — Pulito Trade',
...
const calculatorJsonLd = {
  ...
  description:
    "Калькулятор допоможе визначити потреби вашої сім'ї у побутовій хімії та розрахувати щомісячні витрати.",
  step: [
    {
      '@type': 'HowToStep',
