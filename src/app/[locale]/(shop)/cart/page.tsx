...
// Below-the-fold recommendations — defer until cart items render. ssr:false
// because it relies on the local cart context.
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          onClick={() => {
            if (window.confirm('Видалити всі товари з кошика? Цю дію не можна скасувати.')) {
              clearCart();
            }
          }}
