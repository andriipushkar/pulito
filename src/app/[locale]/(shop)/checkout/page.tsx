      ...
      <div className="gap-6 lg:grid lg:grid-cols-[1fr_340px]">
        ...
        <div className="space-y-3">
          ...
          <div className="sticky bottom-0 -mx-4 border-t border-[var(--color-border)] bg-[var(--color-bg)] px-4 py-3 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none">
            ...
            {/* Payment method badges — текстові, без зовнішніх логотипів
                щоб не тягнути додаткові network requests і не порушувати CSP. */}
            <div className="mt-2 flex flex-wrap items-center justify-center gap-1.5 text-[10px] font-bold tracking-wide text-[var(--color-text-secondary)]">
              <span className="rounded border border-[var(--color-border)] bg-white px-1.5 py-0.5">
                VISA
              </span>
              <span className="rounded border border-[var(--color-border)] bg-white px-1.5 py-0.5">
                MASTERCARD
