...
const SECTIONS: ManualSection[] = [
  ...
  {
    title: '8. Бот (Telegram)',
    content: [
      'Telegram-бот дозволяє клієнтам отримувати сповіщення про статус замовлення.',
      'Налаштування бота: Адмін → Боти → обрати платформу.',
  ...
  },
  {
    ...
    content: [
      'Розділ "Публікації" дозволяє створювати пости для соціальних мереж (Telegram, Instagram, Facebook).',
