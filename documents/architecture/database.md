...
- **Гуртовий статус** (`WholesaleStatus`): `none` -> `pending` -> `approved` / `rejected`
...
Історія змін цін товарів. Зберігає старі та нові роздрібні/гуртові ціни.
...
Персональні ціни для гуртових клієнтів. Може бути знижка (`discountPercent`) або фіксована ціна (`fixedPrice`) на продукт чи категорію.
...
Правила для гуртових клієнтів. Типи: `min_order_amount`, `min_quantity`, `multiplicity`.
