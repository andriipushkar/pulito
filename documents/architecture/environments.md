...
| -------------- | ------ | -------------- | --------------------------------------------------------------------- | ---------------------------------------------------- |
| `DATABASE_URL` | string | **Так**        | PostgreSQL connection string                                          | `postgresql://user:pass@localhost:5432/pulito_trade` |
...
| Змінна                | Тип    | Обов'язковість | Опис                     | Приклад           |
| --------------------- | ------ | -------------- | ------------------------ | ----------------- |
| `TELEGRAM_CHANNEL_ID` | string | Ні             | ID каналу для публікацій | `@pulito_channel` |

## Приклад .env файлу

```env
# === Обов'язкові ===
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/pulito_trade
