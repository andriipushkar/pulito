...
| [05-payment-providers.md](05-payment-providers.md)   | Оплата (LiqPay + Sandbox + paypart, Monobank, WayForPay, Apple/Google Pay)      |
| [06-delivery-providers.md](06-delivery-providers.md) | Доставка (НП + D2D + autocomplete, Укрпошта + autocomplete, auto-TTN, bulk TTN) |
...
| [26-background-removal.md](26-background-removal.md) | Авто-видалення фону фото товару (remove.bg)                                     |
| [27-image-processing.md](27-image-processing.md)     | Обробка зображень (формати, padding, watermark, регенерація)                    |
| [28-cron-jobs.md](28-cron-jobs.md)                   | Cron-задачі (всі endpoints + schedule recommendations)                          |
...
| [../operations/admin-settings-reference.md](../operations/admin-settings-reference.md) | Повний довідник DB-налаштувань (admin panel)    |
| [../operations/manual-testing-checklist.md](../operations/manual-testing-checklist.md) | Чек-ліст ручного тестування перед релізом       |
